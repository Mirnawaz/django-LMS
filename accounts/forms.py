...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('firstName', 'lastName', 'email', 'password1', 'password2', 'user_type','dob','gender','address','city',
            'state','country','contact','active', 'applicant')}
        ),
    )
    ...
    readonly_fields = ['firstName', 'lastName', 'email','user_type','dob','gender','address','city',
            'state','country','contact','active']
